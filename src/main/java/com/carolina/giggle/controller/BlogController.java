...
import com.carolina.giggle.util.FileUploadUtil;
...
public class BlogController {
    ...
    public String blogPostAdd(@RequestParam("title") String title,
        ...
        Post post = new Post(title, anons, full_text, getCurrentUsername(), fileName);
        String uploadDir = "src/main/resources/templates/user/picture/";
